...
## 2024-06-23 - [Mongoose Query Index Alignment]
...
**Action:** Ensure that `.sort()` parameters align perfectly with the chosen compound index to avoid blocking in-memory sorts.
