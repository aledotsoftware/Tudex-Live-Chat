...
## 2024-06-19 - [Mongoose Compound Index Sort Optimization]
**Learning:** When optimizing Mongoose queries, adding unindexed tie-breaker fields (e.g., `createdAt: -1`) to a query sorted by a partially matched index (e.g., `timestamp: -1`) will trigger a slow, memory-intensive in-memory sort.
