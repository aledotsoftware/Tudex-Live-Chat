              ...
              <div className="settingsContentPane">
                ...
                {activeSettingsTab === 'profile' && (
                  <>
                    ...
                    {/* BR-PWA-005: PWA Installation Status Card */}
                    <div style={{ marginTop: '16px', background: 'rgba(255,255,255,0.02)', padding: '16px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.04)' }}>
                      <h4 style={{ color: '#fff', fontSize: '0.95rem', fontWeight: '600', marginBottom: '8px' }}>Aplicación PWA</h4>
                      <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', marginBottom: '12px', lineHeight: '1.4' }}>
                        Instala Tudex Live Chat como aplicación de escritorio o móvil para acceder sin barras del navegador y con mejor rendimiento.
                      </p>
                      {(window.matchMedia('(display-mode: standalone)').matches || window.navigator.standalone === true || document.referrer.startsWith('android-app://')) ? (
                        <span style={{ fontSize: '0.85rem', color: 'var(--success)', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '6px' }}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                            <polyline points="20 6 9 17 4 12"/>
                          </svg>
                          Aplicación PWA instalada en este dispositivo
                        </span>
                      ) : (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', alignItems: 'flex-start' }}>
                          <span style={{ fontSize: '0.85rem', color: '#38bdf8', fontWeight: '500', display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                              <circle cx="12" cy="12" r="10"/>
                              <line x1="12" y1="8" x2="12" y2="12"/>
                              <line x1="12" y1="16" x2="12.01" y2="16"/>
                            </svg>
                            Ejecutándose en navegador (PWA no instalada)
                          </span>
                          <button
                            type="button"
                            onClick={() => {
                              if (window.deferredPwaPrompt) {
                                ...
                                if (/iphone|ipad|ipod/.test(userAgent)) {
                                  showNotice("En iOS: Pulsa 'Compartir' ⎋ y luego 'Agregar a inicio' ⊕.", "info");
                                } else {
                                  showNotice("Usa la opción 'Instalar aplicación' en el menú de tu navegador.", "info");
                                }
                              }
                            }}
                            style={{
